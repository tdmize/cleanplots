...
**Bar/area colors** (`palette = "bars"`) -- softer versions used for
bar charts, area plots, and pie charts, which use far more ink than
points and lines:
...
groups are distinguishable by lightness alone when printed in black &
...
(minimum Delta-E of about 21). Check the palette yourself at
...
`theme_cleanplots()`: white background, no plot border, light gray axis
lines and ticks, dotted light gray gridlines, a frameless, untitled
legend at the right, and black-outlined facet strips with bold labels.
To restore a legend title:
...
Colors, marker symbols, line patterns, and layout match this package,
so figures made in R and Stata look like siblings.
