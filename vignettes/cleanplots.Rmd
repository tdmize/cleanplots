...
The examples below use simulated data on life satisfaction across
ages:
...
```{r preds-continuous, eval = has_mfx}
...
```{r preds-draw-false, eval = has_mfx}
